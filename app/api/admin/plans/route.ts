...
export async function PUT(req: Request) {
  ...
  const { data: updated, error } = await admin
    ...
    .update({
      ...
      price_usd: price_usd !== undefined && price_usd !== '' && price_usd !== null ? Number(price_usd) : null,
      annual_price_usd: annual_price_usd !== undefined && annual_price_usd !== '' && annual_price_usd !== null ? Number(annual_price_usd) : null,
      expert_review_price_usd: expert_review_price_usd !== undefined && expert_review_price_usd !== '' && expert_review_price_usd !== null ? Number(expert_review_price_usd) : null,
