...
import { FSVPIntegrationBanner } from '@/components/audit/cards/fsvp-integration-banner'
            ...
            <Card className={`overflow-hidden border-2 ${
              ...
              <div className="p-6">
                ...
                <div className="space-y-4">
                  ...
                  {/* FSVP Integration Banner - Show when imported product detected */}
                  <FSVPIntegrationBanner
                    report={report}
                    productName={report.product_name}
                    productCategory={report.product_category}
                    countryOfOrigin={(report as any).country_of_origin}
                    isImported={(report as any).is_imported}
                  />
                </div>
              </div>
            </Card>
