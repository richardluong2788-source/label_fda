...
<div class="page content-page page-break">
  ...
  <div class="section">
    ...
    <div class="data-box">
      ...
      ${report.nutrition_facts && Object.values(report.nutrition_facts).some(v => v) ? `
...
<div class="page content-page"><!-- No page-break: flows naturally -->
  ...
  <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:20px;padding:14px 18px;background:linear-gradient(90deg, #1e3a8a 0%, #2563eb 100%);border-radius:10px;color:white;page-break-inside:avoid;">
  ...
  <div class="section" style="page-break-inside:avoid;">
    ...
    <div style="background:#EFF6FF;border:1px solid #BFDBFE;border-radius:10px;padding:16px;font-size:10px;color:#1e40af;line-height:1.7;overflow-wrap:break-word;max-height:200px;overflow-y:auto;">
  ...
  <div class="section" style="page-break-inside:avoid;">
    ...
    <div style="max-height:300px;overflow-y:auto;">
      ${expertReview.violation_reviews.map((vr) => {
        ...
        return `
      <div style="background:${bgColor};border:1px solid ${borderColor};border-radius:8px;padding:12px;margin-bottom:10px;page-break-inside:avoid;overflow:hidden;">
        <div style="display:flex;align-items:center;gap:6px;margin-bottom:8px;">
          <span style="color:${iconColor};font-size:12px;">${icon}</span>
          <span style="font-size:10px;font-weight:600;color:#334155;overflow-wrap:break-word;">
        ...
        <div style="margin-top:8px;">
          ...
          <div style="background:white;border:1px solid #e2e8f0;border-radius:6px;padding:10px;font-size:9px;color:#0f172a;line-height:1.6;overflow-wrap:break-word;max-height:100px;overflow-y:auto;">
            ${escapeHtml(vr.wording_fix)}
          </div>
        </div>` : ''}
        ${vr.legal_note ? `
        <div style="margin-top:8px;font-size:8px;color:#64748b;font-style:italic;overflow-wrap:break-word;max-height:80px;overflow-y:auto;">
  ...
  <div class="section" style="page-break-inside:avoid;">
    ...
    <div style="max-height:250px;overflow-y:auto;">
      ${expertReview.recommended_actions.map((ra) => {
        ...
        return `
      <div style="display:flex;align-items:flex-start;gap:10px;padding:8px 0;border-bottom:1px solid #f1f5f9;overflow:hidden;">
        <span style="font-size:8px;font-weight:700;color:${priorityColor};background:${priorityBg};padding:3px 8px;border-radius:4px;white-space:nowrap;flex-shrink:0;">${priorityLabel}</span>
        <span style="font-size:9px;color:#334155;flex:1;overflow-wrap:break-word;">${escapeHtml(ra.action)}</span>
        ${ra.cfr_reference ? `<span style="font-size:8px;color:#64748b;white-space:nowrap;flex-shrink:0;">(${escapeHtml(ra.cfr_reference)})</span>` : ''}
      </div>`
      }).join('')}
    </div>
  </div>` : ''}
