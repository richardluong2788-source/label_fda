...
export const PACKAGING_FORMATS: PackagingFormat[] = [
  ...
  // ------- OUTER CARTON -------
  {
    ...
    defaultFdaRegulations: ['21 CFR 101.100(d)', '21 CFR 101.2(c)', '21 CFR 101.105'],
    defaultFdaNotes: [
    ...
    domainOverrides: {
      ...
      cosmetic: {
        ...
        fdaRegulations: ['21 CFR 701.12', 'MoCRA 2022'],
        fdaNotes: [
          ...
          'Country of origin marking per customs regulations',
        ],
        fdaNotesVi: [
