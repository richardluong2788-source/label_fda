export const vi = {
  ...
  report: {
    ...
    images: 'HÌNH ẢNH',
    productInfoAI: 'THÔNG TIN SẢN PHẨM (AI)',
    brand: 'THƯƠNG HIỆU',
  ...
  landing: {
    ...
    classI: { title: 'Class I', subtitle: 'Mức nguy hiểm cao nhất', desc: 'Có thể gây hại sức khỏe nghiêm trọng hoặc tử vong. Phải thu h�����i toàn bộ ngay lập tức.' },
  ...
  pdf: {
    ...
    importAlerts: 'Cảnh Báo Nhập Khẩu FDA',
    technicalCheck: 'Kiểm Tra K�� Thuật & Hình ���nh',
