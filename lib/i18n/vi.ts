export const vi = {
  ...
  analyze: {
    imageTypes: {
      pdp: { label: 'Mặt trước (PDP)', description: 'Mặt chính của bao bì — có Net Weight, thương hiệu, tên sản phẩm' },
      ...
      ingredients: { label: 'Thành phần & Chất gây dị ứng', description: 'Danh sách nguyên liệu và cảnh báo dị ứng' },
      other: { label: 'Mặt khác', description: 'Công bố, cảnh báo hoặc thông tin bổ sung' },
    },
    kbTrainedOn: (count: number) => `AI được huấn luyện trên ${count.toLocaleString()} tài liệu FDA thực tế`,
    kbNoData: 'Hệ thống Knowledge Base chưa có dữ liệu - Liên hệ Admin để nạp tài liệu',
    heroTitle: 'Phát hiện Vi phạm FDA',
    heroTitleHighlight: 'Trước khi Hàng bị Từ chối',
    ...
    ctaDescSuffix: 'Nhận báo cáo chi tiết với trích dẫn quy định và hướng dẫn sửa lỗi trong vài phút.',
    analyzing: 'Đang phân tích...',
    scanNow: 'Quét Vi phạm FDA ngay (Miễn phí xem trước)',
    freePreviewNote: 'Miễn phí xem trước vi phạm nghiêm trọng. Mở khóa báo cáo đầy đủ để xuất PDF và nhận tư vấn chi tiết.',
  ...
  contactExpert: 'Liên hệ chuyên gia Vexim',
    ...
    designRecommendation: 'Khuyến nghị thiết kế',
    notFdaRequired: 'Không bắt buộc theo CFR',
    designNote: 'GỢI Ý',
    designRecommendations: 'khuyến nghị thiết kế',
    contrastTitle: 'Độ tương phản màu sắc thấp',
    contrastRef: 'Yêu cầu FDA về độ rõ ràng của nhãn',
    contrastRatio: (ratio: number, minRatio?: number) => `Tỷ lệ tương phản ${ratio.toFixed(2)}:1 (Khuyến nghị tối thiểu ${(minRatio ?? 3.0).toFixed(1)}:1)`,
  ...
  analysisProgress: {
    ...
    fdaProcessTitle: 'Quy trình Kiểm tra FDA',
  ...
  advancedForm: {
    ...
    selectProductFirst: (domains: string) => `Vui lòng chọn Loại sản phẩm trước đó hiển thị quy định FDA chính xác cho từng ngành (${domains}).`,
  ...
  guide: {
    ...
    imageTypes: [
      ...
      {
        id: 'nutrition', label: 'Bảng Nutrition Facts', subtitle: 'Nutrition Facts Panel', badge: 'B���t buộc',
  ...
  landing: {
    ...
    personasDesc: 'Dù đang chuẩn bị xuất khẩu lần đầu hay đã t���ng bị FDA cảnh cáo - Vexim đều có giải pháp phù hợp.',
    ...
    samplePass1: 'Mặt hiển thị chính có đầy ��������ủ Tên sản phẩm, Khối lượng tịnh, Nhãn hiệu. Kích thước chữ đạt yêu cầu tối thiểu.',
    // Why trust
    whyTrustItems: [
    ...
    finalCtaDesc: 'Hơn 200 doanh nghiệp Việt Nam đã sử dụng Vexim để bảo vệ lô hàng, giữ vững uy tín thương hiệu và đảm bảo hợp đồng xuất khẩu không b�� gián đo���n.',
    finalCtaButton: 'Kiểm tra nh��n miễn phí — Bắt đầu trong 2 phút',
