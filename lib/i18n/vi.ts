...
structureFunctionClaimsTitle: 'CÔNG BỐ CẤU TRÚC/CHỨC NĂNG (CẦN DSHEA)',
  ...
  cosmeticClaimsTitle: 'CÔNG BỐ MỸ PHẨM (CẦN XEM XÉT)',
  cosmeticClaimsHint: 'Đây là các công bố hiệu năng mỹ phẩm. Cần đảm bảo có căn cứ và không gây hiểu lầm theo FD&C Act Section 602.',
  ...
  settings: {
    ...
    outOfQuota: 'Đã hết quota — nâng cấp gói để tiếp tục s�� dụng.',
