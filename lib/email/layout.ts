...
<table cellpadding="0" cellspacing="0" border="0" style="margin-top:24px;">
  <tr>
    <td style="background-color:#0f172a;border-radius:8px;">
      <a href="${url}" style="display:inline-block;padding:14px 28px;color:#ffffff;font-size:15px;font-weight:600;text-decoration:none;letter-spacing:-0.2px;">${text}</a>
    </td>
  </tr>
</table>`
}

export function badge(text: string, color: 'blue' | 'green' | 'orange' | 'red' = 'blue') {
  const colors = {
